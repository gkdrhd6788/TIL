...
1. 568이하는 어떻게 표현하나 둘다 써야하는건가

# Bootstrap Grid system

* 1 row-12 columns: 약수가 적당하게 많아서(경우의 수)

* Nesting :  큰 틀부터 나누기

* gutters
  - 컬럼과 컬럼 사이
  - x축은 padding( --> 서로의 몸집을 축소. if margin을 주면 행자체의 길이가 길어짐 ), y축은 margin

# Grid system for responsive web

* 1 row- 12 columns- 6 breakpoints
* 화면 **너비**에 따라 6개의 분기점
* (주의!!) breakpoints는 ~이상의 의미--> offset 쓸 때 주의 & 모든 사이즈에 대해 breakpoint 안써도 됨 
* col - 크기 지정 없으면 가장 작은 사이즈
